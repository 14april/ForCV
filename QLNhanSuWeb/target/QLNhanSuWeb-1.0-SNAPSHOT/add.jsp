...
<div class="container" id="main-content">
      <div class="row justify-content-center">
          ...
          <div class="mb-3">
            ...
            <input class="form-control" name="hoNV" type="text"  />
          </div>
          <div class="mb-3">
             <label class="form-label">Last Name</label>
            <input class="form-control" name="tenNV" type="text"  />
          </div>
          <div class="mb-3">
             <label class="form-label">Sex</label>
             <div>
                 <input class="form-check-input" type="radio" name="phai" />  Male                       
               <input class="form-check-input" type="radio"  name="phai"  />  Female                
             </div>
          </div>
          
          <div class="mb-3">
             <label class="form-label">Year of birth</label>
            <input class="form-control" type="text"  name="namSinh" placeholder="Year of birth..." />
          </div>
           <div class="mb-3">
             <label class="form-label">Place of birth</label>
            <input class="form-control" type="text"  name="noiSinh" placeholder="Place of birth..." />
          </div>
          ...
          <div class="mb-3">
             ...
             <select class="form-control" name="maphong">
                 <c:forEach var="x" items="${listPhong}">
                     <option value="${x.maPhong}">${x.tenPhong}</option>
                 </c:forEach>
